...
# This module can use either poll() or select() as the "polling model".
#
# A model function takes an fd, bools for readability, writablity, and
...
def _wait_for(fd, readable, writable, error, expiration):
    # Use the selected polling model to wait for any of the specified
