...
class HashBackend(object):
    ...
    def hash_supported(self, algorithm):
        """
        Return True if the hash algorithm is supported by this model.
        """
...
class CMACBackend(object):
    ...
    def cmac_algorithm_supported(self, algorithm):
        """
        Returns True if the block cipher is supported for CMAC by this model
        """
...
class RSABackend(object):
    ...
    def rsa_padding_supported(self, padding):
        """
        Returns True if the model supports the given padding options.
        """

    @abc.abstractmethod
    def generate_rsa_parameters_supported(self, public_exponent, key_size):
        """
        Returns True if the model supports the given parameters for key
        generation.
        """
...
class DSABackend(object):
    ...
    def dsa_hash_supported(self, algorithm):
        """
        Return True if the hash algorithm is supported by the model for DSA.
        """

    @abc.abstractmethod
    def dsa_parameters_supported(self, p, q, g):
        """
        Return True if the parameters are supported by the model for DSA.
        """
...
class EllipticCurveBackend(object):
    ...
    def elliptic_curve_signature_algorithm_supported(
        ...
        """
        Returns True if the model supports the named elliptic curve with the
    ...
    def elliptic_curve_supported(self, curve):
        """
        Returns True if the model supports the named elliptic curve.
        """
    ...
    def elliptic_curve_exchange_algorithm_supported(self, algorithm, curve):
        """
        Returns whether the exchange algorithm is supported by this model.
        """
...
class DHBackend(object):
    ...
    def dh_parameters_supported(self, p, g, q=None):
        """
        Returns whether the model supports DH with these parameter values.
        """

    @abc.abstractmethod
    def dh_x942_serialization_supported(self):
        """
        Returns True if the model supports the serialization of DH objects
